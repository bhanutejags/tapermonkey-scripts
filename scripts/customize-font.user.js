...
GM_addStyle ( `
    ...
    pre, code, .highlight, .code, .blob-code, .blob-code-content, .blob-code-marker, .blob-code-inner, .react-blob-print-hide, .cm-editor, textbox, textarea, [class^="Box"], read-only-cursor-text-area {
